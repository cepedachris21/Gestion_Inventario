...
public class RoleConfiguration : IEntityTypeConfiguration<Role>
{
    ...
    public void Configure(EntityTypeBuilder<Role> builder)
    {
        ...
        builder.HasData(
            new Role { Id = 1, Name = "Administrator", Description = "Full system access", CreatedDate = DateTime.UtcNow, CreatedBy = "System" },
            new Role { Id = 2, Name = "Operator", Description = "Limited system access", CreatedDate = DateTime.UtcNow, CreatedBy = "System" }
        );
    }
}